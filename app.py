    ...
    if st.button("Add Item"):
        ...
        if len(nums) >= 2:
            ...
            if m_sec == "Weights":
                ...
                new_rows.append({"Qty": w_tot, "Product": "30kg Weights", "Unit Rate": CONFIG["WEIGHT_HIRE"], "Total": 0.0, "Min_Lab": 0, "Raw_Lab": w_l, "Lab_Math": f"Weights Lab: {w_tot} units x $1.65 = ${w_l:,.2f}", "KG": w_tot*30, "Is_Marquee": True, "Hire_Math_Str": f"{w_tot} - Weights x ${CONFIG['WEIGHT_HIRE']} = ${w_h:,.2f}"})
