        ...
        if cov_input is None or cov_input <= 0:
            ...
            if "supa" in target_item.lower():
                ...
                new_f_df = pd.DataFrame([{
                    ...
                    "Min_Lab": 0, "Raw_Lab": num_sheets_needed * f_lab,
                    "Lab_Math": f"{target_item}: Layering {num_sheets_needed} sheets x ${f_lab:.2f}", 
                    "KG": num_sheets_needed * f_kg, "Is_Marquee": False, "Discount": 0.0, "Lab_Per_Unit": 0, 
                    "Base_Hire": proportional_sheet_rate, "Anchoring": "", "Override_Rate": 0.0, "Is_Flooring": True,
                ...
                new_f_df = pd.DataFrame([{
                    ...
                    "Unit Rate": f_rate, 
                    "Min_Lab": 0, "Raw_Lab": cov_input * f_lab,
                    "Lab_Math": f"{target_item}: Rollout layout {cov_input:g} SQM x ${f_lab:.2f}", 
                    "KG": cov_input * f_kg, "Is_Marquee": False, "Discount": 0.0, "Lab_Per_Unit": 0, 
                    "Base_Hire": f_rate, "Anchoring": "", "Override_Rate": 0.0, "Is_Flooring": True,
